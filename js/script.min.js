(function($) {
      ...
      $(".txt-fx").each(function() {
          ...
          $.each(words, function(index, word) {
              ...
              for (var i = 0; i < word.length; i++) {
                  newHtml += '<span class="letter" style="transition-delay:' + (300 + 10 * delay) + 'ms;">' + word[i] + '</span>';
                  delay++;
              }
              newHtml += '</span>';
              
              // Add space
              newHtml += '<span class="letter" style="transition-delay:300ms;">&nbsp;</span>';
              delay++;
          });
  ...
  var initSearchPopup = function() {
      ...
      $(".search-popup").on("click", function(e) {
          if ($(e.target).is(".search-popup-close") || $(e.target).is(".search-popup-close svg") || $(e.target).is(".search-popup-close path") || $(e.target).is(".search-popup")) {
              e.preventDefault();
